...
export default function Footer() {
   return (
      <footer className="bg-[#0d133e] dark:bg-gray-400">
            ...
            <div className="md:flex md:justify-between">
               <div className="mb-6 md:mb-0 md:w-1/4">
                  ...
                  <div className="flex space-x-5 mt-4">
                     ...
                     {/* Código similar para otras redes sociales */}
               ...
               <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 md:w-1/2">
                  <div className="mb-8 sm:mb-0">
                     ...
                     <ul className="text-gray-400 dark:text-gray-400 font-medium grid gap-y-4">
                        <li>
